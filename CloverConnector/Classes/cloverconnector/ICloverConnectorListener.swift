...
public protocol ICloverConnectorListener : AnyObject {
    ...
    /// - Parameter tipAdjustResponse: The response to the transaction request.
    ...
    /// object with a token value that's unique for the card and merchant. The token can 
    /// be used for future Sale() and Auth() requests.
    ...
    /// - Parameter printManualRefundReceiptMessage A callback that asks the POS to print 
    ...
    /// - Parameter printManualRefundDeclineReceiptMessage The 
    ...
    /// - Parameter customActivityResponse The response.
    ...
    /// - Parameter response The message from the Custom Activity.
